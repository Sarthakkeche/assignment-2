...
int partition (stud s[20],int n,int key);
    ...
    do{
        ...
        case 7:
         ...
         cin>>x;
              ...
              if (result==-1){
                cout<<"\n The student name you want to search for is naot present !\n";
              } 
              else{
                cout<<"\n the student is presnt :\t"<<s[result].name;
              }
              break;
        ...
        case 8: return 0;
         ...
         default :cout<<"\n Invalid choice !! please enter your choice agsin."<<endl;
